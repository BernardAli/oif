...
ALL_CAPS = {
    ...
    CAP_VIEW_PARTNERS, CAP_APPROVE_CONTENT, CAP_CONFIGURE, CAP_VIEW_AUDIT,
} | BASE_CAPS
...
ROLE_CAPABILITIES = {
    ...
    Role.DIRECTOR: {
        ...
        CAP_VIEW_PARTNERS, CAP_APPROVE_CONTENT,
    } | BASE_CAPS,
    Role.DIR_PROGRAMS: {
